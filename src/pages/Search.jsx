...
import { useGetSearchQuery, useGetTrackDetailsQuery } from '../redux/services/shazamCore';
...
const {data:songs,isFetching:songFetching,error:songError}= useGetTrackDetailsQuery({songid});
